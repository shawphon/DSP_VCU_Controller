...
void main ()
{
    ...
    ConfigCpuTimer(&CpuTimer1, 150, 8);	//CpuTimer1 周期1us
	#endif
	#if (CPU_FRQ_100MHZ)
    ...
    CpuTimer0Regs.TCR.all = 0x4000;     //启动定时器 发送全局消息，同步时钟
	for(;;);
...
void ConfigECANA()
{
	...
	ECanaMboxes.MBOX2.MSGID.bit.STDMSGID = 0x0003;
	//邮箱3		发送邮箱		消息M6
	ECanaMboxes.MBOX3.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX3.MSGID.bit.STDMSGID = 0x0006;
	//邮箱4		发送邮箱		消息M9
	ECanaMboxes.MBOX4.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX4.MSGID.bit.STDMSGID = 0x0009;
	//邮箱5		发送邮箱		消息M10
	ECanaMboxes.MBOX5.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX5.MSGID.bit.STDMSGID = 0x000A;
	//邮箱6		发送邮箱		消息M14
	ECanaMboxes.MBOX6.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX6.MSGID.bit.STDMSGID = 0x000E;
	//邮箱31		接收邮箱		消息M1
	...
	ECanaMboxes.MBOX28.MSGID.bit.STDMSGID = 0x0005;
	//邮箱27		接收邮箱		消息M7
	ECanaMboxes.MBOX27.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX27.MSGID.bit.STDMSGID = 0x0007;
	//邮箱26		接收邮箱		消息M8
	ECanaMboxes.MBOX26.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX26.MSGID.bit.STDMSGID = 0x0008;
	//邮箱25		接收邮箱		消息M12
	ECanaMboxes.MBOX25.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX25.MSGID.bit.STDMSGID = 0x000C;
	//邮箱24		接收邮箱		消息M13
	ECanaMboxes.MBOX24.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX24.MSGID.bit.STDMSGID = 0x000D;
	...
	//邮箱3		发送邮箱		消息M6
    ECanaMboxes.MBOX3.MSGCTRL.bit.DLC = 6;
	//邮箱4		发送邮箱		消息M9
	...
	//邮箱28		接收邮箱		消息M5
    ECanaMboxes.MBOX28.MSGCTRL.bit.DLC = 6;
	//邮箱27		接收邮箱		消息M7
    ECanaMboxes.MBOX27.MSGCTRL.bit.DLC = 6;
	//邮箱26		接收邮箱		消息M8
    ECanaMboxes.MBOX26.MSGCTRL.bit.DLC = 8;
	//邮箱25		接收邮箱		消息M12
    ECanaMboxes.MBOX25.MSGCTRL.bit.DLC = 5;
	//邮箱24		接收邮箱		消息M13
    ECanaMboxes.MBOX24.MSGCTRL.bit.DLC = 7;
...
void ConfigECANB()
{
	...
	ECanbMboxes.MBOX0.MSGID.bit.STDMSGID = 0x000F;
	//邮箱1		发送邮箱		消息M2
	ECanbMboxes.MBOX1.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX1.MSGID.bit.STDMSGID = 0x0002;
	//邮箱2		发送邮箱		消息M3
	ECanbMboxes.MBOX2.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX2.MSGID.bit.STDMSGID = 0x0003;
	//邮箱3		发送邮箱		消息M6
	ECanbMboxes.MBOX3.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX3.MSGID.bit.STDMSGID = 0x0006;
	//邮箱4		发送邮箱		消息M9
	ECanbMboxes.MBOX4.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX4.MSGID.bit.STDMSGID = 0x0009;
	//邮箱5		发送邮箱		消息M10
	ECanbMboxes.MBOX5.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX5.MSGID.bit.STDMSGID = 0x000A;
	//邮箱6		发送邮箱		消息M14
	ECanbMboxes.MBOX6.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX6.MSGID.bit.STDMSGID = 0x000E;
	//邮箱31		接收邮箱		消息M1
	ECanbMboxes.MBOX31.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX31.MSGID.bit.STDMSGID = 0x0001;
	//邮箱30		接收邮箱		消息M4
	ECanbMboxes.MBOX30.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX30.MSGID.bit.STDMSGID = 0x0004;
	//邮箱29		接收邮箱		消息M11
	ECanbMboxes.MBOX29.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX29.MSGID.bit.STDMSGID = 0x000B;
	//邮箱28		接收邮箱		消息M5
	ECanbMboxes.MBOX28.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX28.MSGID.bit.STDMSGID = 0x0005;
	//邮箱27		接收邮箱		消息M7
	ECanbMboxes.MBOX27.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX27.MSGID.bit.STDMSGID = 0x0007;
	//邮箱26		接收邮箱		消息M8
	ECanbMboxes.MBOX26.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX26.MSGID.bit.STDMSGID = 0x0008;
	//邮箱25		接收邮箱		消息M12
	ECanbMboxes.MBOX25.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX25.MSGID.bit.STDMSGID = 0x000C;
	//邮箱24		接收邮箱		消息M13
	ECanbMboxes.MBOX24.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX24.MSGID.bit.STDMSGID = 0x000D;
     ...
     * 设定邮箱的数据长度*/
	//CANA 中设置 邮箱0 为发送邮箱， 消息: 参考消息
    ECanbMboxes.MBOX0.MSGCTRL.bit.DLC = 1;
	//邮箱1		发送邮箱		消息M2 2
    ECanbMboxes.MBOX1.MSGCTRL.bit.DLC = 7;
	//邮箱2		发送邮箱		消息M3 3
    ECanbMboxes.MBOX2.MSGCTRL.bit.DLC = 7;
	//邮箱3		发送邮箱		消息M6 6
    ECanbMboxes.MBOX3.MSGCTRL.bit.DLC = 6;
	//邮箱4		发送邮箱		消息M9 9
	...
	//邮箱31		接收邮箱		消息M1
    ECanbMboxes.MBOX31.MSGCTRL.bit.DLC = 4;
	//邮箱30		接收邮箱		消息M4
    ECanbMboxes.MBOX30.MSGCTRL.bit.DLC = 6;
	//邮箱29		接收邮箱		消息M11
    ECanbMboxes.MBOX29.MSGCTRL.bit.DLC = 8;
	//邮箱28		接收邮箱		消息M5
    ECanbMboxes.MBOX28.MSGCTRL.bit.DLC = 6;
	//邮箱27		接收邮箱		消息M7
    ECanbMboxes.MBOX27.MSGCTRL.bit.DLC = 6;
	//邮箱26		接收邮箱		消息M8
    ECanbMboxes.MBOX26.MSGCTRL.bit.DLC = 8;
	//邮箱25		接收邮箱		消息M12
    ECanbMboxes.MBOX25.MSGCTRL.bit.DLC = 5;
	//邮箱24		接收邮箱		消息M13
    ECanbMboxes.MBOX24.MSGCTRL.bit.DLC = 7;
    ...
    ECanbShadow.CANMC.bit.STM = 0;    // Configure CAN for self-test mode,just configure CAN for normal mode.
    ECanbRegs.CANMC.all = ECanbShadow.CANMC.all;

    ECanbShadow.CANME.all = ECanbRegs.CANME.all;             //邮箱使能
