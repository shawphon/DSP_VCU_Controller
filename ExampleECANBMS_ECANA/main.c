...
void main ()
{
    ...
    ConfigCpuTimer(&CpuTimer1, 150, 8);	//CpuTimer1 周期2us
	#endif
	#if (CPU_FRQ_100MHZ)
...
void ConfigECANA()
{
	...
	ECanaMboxes.MBOX1.MSGID.bit.STDMSGID = 0x000E;

	//邮箱31		发送邮箱		消息M5
	ECanaMboxes.MBOX31.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX31.MSGID.bit.STDMSGID = 0x0005;
	//邮箱30		发送邮箱		消息M7
	ECanaMboxes.MBOX30.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX30.MSGID.bit.STDMSGID = 0x0007;
	...
	//邮箱31		发送邮箱		消息M1
    ECanaMboxes.MBOX31.MSGCTRL.bit.DLC = 6;
	//邮箱30		接收邮箱		消息M4
