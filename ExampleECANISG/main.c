...
void ConfigECANA()
{
	...
	ECanaMboxes.MBOX1.MSGID.bit.STDMSGID = 0x0003;
	//邮箱2		接收邮箱		消息M6
	ECanaMboxes.MBOX2.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX2.MSGID.bit.STDMSGID = 0x0006;

	//邮箱31		发送邮箱		消息M8
	ECanaMboxes.MBOX31.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX31.MSGID.bit.STDMSGID = 0x0008;
	//邮箱30		接收邮箱		消息M12
	ECanaMboxes.MBOX30.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX30.MSGID.bit.STDMSGID = 0x000C;
	//邮箱29		接收邮箱		消息M13
	ECanaMboxes.MBOX29.MSGID.all = 0x00000000;
	ECanaMboxes.MBOX29.MSGID.bit.STDMSGID = 0x000D;
	...
	//邮箱30		接收邮箱		消息M12
    ECanaMboxes.MBOX30.MSGCTRL.bit.DLC = 5;
	//邮箱29		接收邮箱		消息M13
    ECanaMboxes.MBOX29.MSGCTRL.bit.DLC = 7;
...
void ConfigECANB()
{
	...
	ECanbMboxes.MBOX1.MSGID.bit.STDMSGID = 0x0003;
	//邮箱2		接收邮箱		消息M6
	ECanbMboxes.MBOX2.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX2.MSGID.bit.STDMSGID = 0x0006;

	//邮箱31		发送邮箱		消息M8
	ECanbMboxes.MBOX31.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX31.MSGID.bit.STDMSGID = 0x0008;
	//邮箱30		接收邮箱		消息M12
	ECanbMboxes.MBOX30.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX30.MSGID.bit.STDMSGID = 0x000C;
	//邮箱29		接收邮箱		消息M13
	ECanbMboxes.MBOX29.MSGID.all = 0x00000000;
	ECanbMboxes.MBOX29.MSGID.bit.STDMSGID = 0x000D;
	...
	//邮箱31		发送邮箱
	ECanbShadow.CANMD.bit.MD31 = 0;
	//邮箱30		发送邮箱
	ECanbShadow.CANMD.bit.MD30 = 0;
	//邮箱29		发送邮箱
	ECanbShadow.CANMD.bit.MD29 = 0;
	...
	//邮箱2		接收邮箱		消息M6
    ECanbMboxes.MBOX2.MSGCTRL.bit.DLC = 6;

	//邮箱31		发送邮箱		消息M8
    ECanbMboxes.MBOX31.MSGCTRL.bit.DLC = 8;
	//邮箱30		接收邮箱		消息M12
    ECanbMboxes.MBOX30.MSGCTRL.bit.DLC = 5;
	//邮箱29		接收邮箱		消息M13
    ECanbMboxes.MBOX29.MSGCTRL.bit.DLC = 7;
